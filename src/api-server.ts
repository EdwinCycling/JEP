      ...
      const parser = new XMLParser({
        ...
        isArray: (name, jpath) => {
          const arrayPaths = [
            ...
            "extension.applicationextensions.applicationextension.button",
            "extension.applicationextensions.applicationextension.monitor.item",
            "extension.divisionsettingsextensions.tab",
            "extension.divisionsettingsextensions.tab.section",
            "extension.divisionsettingsextensions.tab.section.setting",
