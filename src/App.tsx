      ...
      <div className="h-screen flex flex-col bg-exact-beige font-sans text-exact-dark overflow-hidden">
              ...
              <AnimatePresence>
                {isMenuOpen && (
                  ...
                  >
                    <button
                      onClick={() => {
                        if (model) setConfirmAction('exit');
        ...
        <footer className="bg-white shrink-0 border-t border-gray-200 py-4 z-10">
          <div className="max-w-[1580px] mx-auto px-4 flex justify-between items-center text-sm font-medium text-gray-500">
            ...
            <div className="text-gray-400 font-mono text-xs">v{APP_VERSION}</div>
          </div>
        </footer>

        {isManagingXsd && <XsdManagerModal onClose={() => setIsManagingXsd(false)} />}
            ...
            >
              <div className="p-6">
                ...
                <div className="space-y-3">
                  ...
                  <button onClick={() => setConfirmAction(null)} className="w-full inline-flex items-center justify-center px-4 py-2.5 text-sm font-medium text-gray-700 bg-gray-100 rounded-lg hover:bg-gray-200 transition-colors">
                    Annuleren
                  </button>
                </div>
              </div>
